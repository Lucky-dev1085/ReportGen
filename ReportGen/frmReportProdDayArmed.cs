...
namespace ReportGen
{
    public partial class frmReportProdDayArmed : Form
    {
        ...
        public frmReportProdDayArmed(DateTime dtf, DateTime dtt, string a)
        {
            InitializeComponent();
            this.dtf = dtf;
            this.dtt = dtt;
        ...
        private void frmReportProdDayArmed_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                myTableAdapter.FillProdByDayArmed(myDataTable, ad, ad2);
